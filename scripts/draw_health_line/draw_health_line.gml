...
draw_line_width(line_x1, line_y1, line_x1 + ((line_x2 - line_x1) * line_prev_percent), line_y2, line_width);
draw_set_color(line_color);
draw_line_width(line_x1, line_y1, line_x1 + ((line_x2 - line_x1) * line_percent), line_y2, line_width);
